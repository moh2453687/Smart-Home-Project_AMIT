...
#define tick 245
/*
tick 31  === 0.5 sec  ------------>>(31*4/245 = 0.5 sec)
tick 62  === 1   sec  ------------>>(62*4/245 = 1 sec  )
tick 93  === 1.5 sec  ------------>>(93*4/245 = 1.5 sec)
tick 124 === 2   sec  ------------>>(124*4/245 = 2 sec )
	 |		   |
	 |		   |
	 V		   V
